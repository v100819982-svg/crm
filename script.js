...
function loadDataFromBot() {
    ...
    if (dataParam) {
        try {
            ...
            console.log('Данные от бота через URL:', data);
            ...
            console.log('Данные загружены от бота через URL');
            return;
        } catch (error) {
    ...
    // Если нет данных в URL, пробуем Telegram WebApp API
    if (window.Telegram && window.Telegram.WebApp) {
        const botData = window.Telegram.WebApp.initData;
        console.log('Данные от бота через WebApp:', botData);
        ...
        if (botData) {
            try {
                ...
                console.log('Данные загружены от бота через WebApp');
            } catch (error) {
...
function updateClientSelect() {
    ...
    clients.forEach(client => {
        ...
        option.textContent = `${client.name} (${client.service})`;
...
function handleAddAppointment(e) {
    ...
    const price = parseInt(document.getElementById('appointmentPrice').value);
